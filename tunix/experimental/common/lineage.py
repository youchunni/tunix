...
class Component:
  """Standard Lineage component identifiers for core Tunix stages."""

  ENGINE_DISPATCH = "engine.dispatch"
  WORKER_ROLLOUT = "worker.rollout"
  ORCHESTRATOR_ASSEMBLER = "orchestrator.assembler"
  WORKER_TRAINER = "worker.trainer"
  ENGINE_TRAIN = "engine.train"


class Operation:
  """Standard Lineage operation identifiers for core Tunix stages."""
